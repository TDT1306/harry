...
//bai 2: nha vao 2 so nguyen a,b. tinh nghiem cua phuong trinh ax+b=0. neu a=0 phuong trinh co vo so nghiem


#include<iostream>
using namespace std;

void nhap(int &a, int &b); // khai bao ham nhap aa,b
...
void nhap(int &a, int &b) // dinh nghia ham nha a,b
{
    cin>>a>>b;
}
